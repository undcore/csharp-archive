...
{
    /// <inheritdoc />
    public partial class AddBlogArchiveSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentBlogCategoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogCategories", x => x.BlogCategoryId);
                    table.ForeignKey(
                        name: "FK_BlogCategories_BlogCategories_ParentBlogCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageUrl = table.Column<string>(type: "nvarchar(320)", maxLength: 320, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogCategories_ParentBlogCategoryId",
